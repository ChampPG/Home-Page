##############################
#   Name: prowlarr_status.py
#   Description: Checks the status of the Prowlarr server
#   Author: Paul Gleason
#   Date: 2025-06-14
#   Version: 1.0.0
#   License: MIT
...
def get_status(url: str) -> int:
    try:
        ...
        if response.status_code not in [200, 401]: # 200 is the default status code, 401 is the login status code
            return False
        return True
